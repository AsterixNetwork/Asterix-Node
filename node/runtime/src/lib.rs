...
/// Runtime version.
#[cfg(feature = "asterix_node_runtime")]
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("asterix"),
	impl_name: create_runtime_str!("asterix-node"),
...
parameter_types! {
	pub const SessionsPerEra: sp_staking::SessionIndex = 6; // 6 hour era
	pub const BondingDuration: pallet_staking::EraIndex = 2 * 28; //14 days bonding duration
	pub const SlashDeferDuration: pallet_staking::EraIndex = 28; // 1/2 the bonding duration.
